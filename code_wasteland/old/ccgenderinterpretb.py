...
figure_title = "GENDER Feature Importances AUC %0.2f_" % roc_auc
...
figure_title = "GENDER Receiver_Operating_Characteristic_AUC_%0.2f_" % roc_auc
timestr = time.strftime("%Y-%m-%d-%H%M")
ext = ".png"
title = figure_title + timestr + ext
plt.savefig(
...
# The sklearn module is pretty easy - maybe use that instead?
...
figure_title = "GENDER Confusion Matrix AUC %0.2f_" % roc_auc
timestr = time.strftime("%Y-%m-%d-%H%M")
ext = ".png"
title = figure_title + timestr + ext
plt.savefig(
