...
TODO: Make this happen at some point. Now is only copy of NOAA script, as a template
"""
...
def get_aq_data(mytoken, dataset, datatypes, stations, start_date, end_date):
    # Check for API token
    if mytoken == "":
...
get_aq_data(mytoken, dataset, datatypes, stations, start_date, end_date)
